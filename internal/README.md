...
Código compartilhado entre serviços, não exposto fora do módulo Go (reforçado pelo compilador -- ver [ADR-012](../docs/adrs/ADR-012-monorepo-go-internal.md)):
...
- `bddcatalog`, `bddguard`, `bddrunner`, `bddsource`: o harness de BDD/Godog deste repositório -- catálogo de cenários, guarda estática contra steps vazios/no-op, e o runner que liga o manifesto aos bindings reais.
